		...
		<div class="table form-group">
			...
			<div class="table_right">
				<div class="input-group input-group-file" id="divFileInput">
					<input id="upload-file-info-caption" type="text" placeholder="{phrase var='user.you_can_upload_a_jpg_gif_or_png_file'}"
						   class="form-control" readonly="">
					<span class="input-group-btn">
					<span class="btn btn-success btn-file">
						<i class="fa fa-upload"></i>
						<input type="file" name="image" accept="image/*" onchange="$('#upload-file-info-caption').val($(this).val().replace(/^.*[\\\/]/, ''));"/>
					</span>
				</span>
				</div>
			</div>			
