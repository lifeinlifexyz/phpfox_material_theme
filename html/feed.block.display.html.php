...
{if Phpfox::isUser() && !defined('FEED_LOAD_MORE_NEWS') && !defined('FEED_LOAD_NEW_FEEDS') && (!isset($bIsGroupMember) || $bIsGroupMember)}
...
{else}
  ...
  {/if}
  {if Phpfox::isUser() && !defined('PHPFOX_IS_USER_PROFILE') && !PHPFOX_IS_AJAX && !defined('PHPFOX_IS_PAGES_VIEW') && Phpfox::getParam('feed.allow_choose_sort_on_feeds')}
      <div class="feed_sort_order">
        <a href="#" class="feed_sort_order_link">{phrase var='feed.sort'} <span class="caret"></span></a>
